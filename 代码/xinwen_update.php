...
<div class="nr">
    ...
    <div class="nr_form">
        <form action="xinwen_update_do.php?id=<?php echo $user_id?>&xinwen_id=<?php echo $xinwen_id; ?>" method="post" enctype="multipart/form-data">
            新闻标题：<input type="text" name="biaoti" value="<?php echo $row['Name']; ?>"><br>
            ...
            新闻图片：<input type="file" name="file"><br>
            <p>新闻内容：</p><textarea name="content" id="" cols="150" rows="20"><?php echo $row['content']; ?></textarea><br>
