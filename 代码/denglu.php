...
<body>
  <div class="container right-panel-active">
    ...
    <div class="container__form container--signup">
      <form action="zhuce.php" class="form" id="form1" method="post">
        ...
        <input type="password" placeholder="Confirm Password" class="input" name="confirm_password" id="confirm_password" />
        <button type="submit" class="btn" name="submit_zhuce" id="signup-btn">注册</button>
      </form>
    </div>

    <!-- Sign In -->
    <div class="container__form container--signin">
      <form action="denglu_do.php" class="form" id="form2" method="post">
        <h2 class="form__title">登录</h2>
        <input type="text" placeholder="Name" class="input" name="Name" />
        <input type="password" placeholder="Password" class="input" name="password" />
        <input type="text" placeholder="验证码" class="input" id="captcha" name="captcha" />
        <img src="" alt="验证码" id="captchaImg" />
        <button type="submit" class="btn" id="signin-btn">登录</button>
      </form>
    </div>
  ...
  <script>
    ...
    secondForm.addEventListener("submit", (e) => {
      ...
      const expectedCaptcha = document.getElementById("captchaImg").alt;
    ...
    function showCaptcha() {
      ...
      captchaImg.src = `https://dummyimage.com/150x50/000/fff.png&text=${captcha}`;
